  ...
  execute: (client, args) => {
    ...
    async function verification() {
      ...
      if (!captchachannel) {
        ...
        return args[0].send(`❌ Sorry, the verification system failed. Please contact a Bot Developer ASAP.`);
      }
